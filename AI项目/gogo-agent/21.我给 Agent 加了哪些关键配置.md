...
多轮对话里，system prompt 和历史前缀几乎不变，每轮重复计费很亏。开这个开关后，框架会自动给 system messages 与最后一条消息打上 cache\_control，命中百炼的隐式缓存，**重复前缀按缓存价计费**：
...
关于利用百炼的隐式缓存的方案前面讲过了，这里讲另外一种——显示缓存 隐式缓存是服务端自动的，但框架可以显式给某些消息打「cache\_control」标记，提示服务端「这几段值得缓存、按缓存规则处理」。在 AgentScope 里就是 G
...
（本期无视频，内容前面也都讲过，文档再总结一下） 大模型的参数里装着「世界的常识」，但装不下三类东西： 硬办法是把所有制度文档塞进 system prompt，但这样既撑爆上下文窗口，又无法按问题动态取用。RAG（Retrieval-Au

LLMentor

  

[✅我给 Agent 加了哪些关键配置](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#slate-title)

[1.模型分层：按「贵不贵」分角色](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c320ec0cf589530fa6ee)

[2.maxIters：给 ReAct 循环上「保险丝」](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c09bec0cf5600d0fa61e)

[3.工具执行：超时 + 自动重试（保稳定）](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c235ec0cf5de510fa6a6)

[4.cacheControl(true)：白嫖百炼隐式缓存](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c320ec0cf53b360fa6f3)

[5.memory：自动压缩/卸载，抑制 token 膨胀](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c235ec0cf548110fa6b2)

[6.长期记忆](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c235ec0cf5f1a10fa6bb)

[7. hooks：把横切能力插进生命周期（保稳定 + 可观测）](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c235ec0cf51c990fa6c1)

[8. 工具与技能：并行、Shell 白名单、子智能体即工具](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c235ec0cf58f0b0fa6c7)

[9. toolExecutionContext：对 LLM 透明的上下文注入](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c235ec0cf5b0f30fa6d0)

[10. RAG 知识库：knowledge + RAGMode.AGENTIC](https://thoughts.aliyun.com/workspaces/6963289eb0fc2e001bb052eb/docs/6a60bf7dd31fed0001cd231b#6a60c235ec0cf533ac0fa6d6)
